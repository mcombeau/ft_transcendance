...
export class ChatGateway implements OnModuleInit {
	...
	async onLeaveSocketRoom(
		...
		try {
			...
			this.logger.warn(`[Leave Socket Room]: ${e.message}`);
			this.server
				.to(
					this.chatGatewayService.getSocketRoomIdentifier(
						info.userID,
	...
	async onJoinSocketRoom(
		...
		try {
			...
			this.logger.warn(`[Join Socket Room]: ${e.message}`);
			this.server
				.to(
					this.chatGatewayService.getSocketRoomIdentifier(
						info.userID,
	...
	async onJoinChat(
		...
		try {
			...
			this.logger.warn(`[Join Chat]: ${e.message}`);
			this.server
				.to(
					this.chatGatewayService.getSocketRoomIdentifier(
						info.userID,
	...
	async onLeaveChat(
		...
		try {
			...
			this.logger.warn(`[Leave Chat]: ${e.message}`);
			this.server
				.to(
					this.chatGatewayService.getSocketRoomIdentifier(
						info.userID,
	...
	async onChatMessage(
		...
		try {
			...
			this.logger.warn(`[Chat Message]: ${e.message}`);
			this.server
				.to(
					this.chatGatewayService.getSocketRoomIdentifier(
						info.userID,
	...
	async onMute(
		...
		try {
			...
			this.logger.warn(`[Mute User]: ${e.message}`);
			this.server
				.to(
					this.chatGatewayService.getSocketRoomIdentifier(
						info.userID,
	...
	async onInvite(
		...
		try {
			...
			this.logger.warn(`[Invite User]: ${e.message}`);
			this.server
				.to(
					this.chatGatewayService.getSocketRoomIdentifier(
						info.userID,
	...
	async onMakeOperator(
		...
		try {
			...
			this.logger.warn(`[Add Operator]: ${e.message}`);
			this.server
				.to(
					this.chatGatewayService.getSocketRoomIdentifier(
						info.userID,
	...
	async onBan(
		...
		try {
			...
			this.logger.warn(`[Ban User]: ${e.message}`);
			this.server
				.to(
					this.chatGatewayService.getSocketRoomIdentifier(
						info.userID,
	...
	async onKick(
		...
		try {
			...
			this.logger.warn(`[Kick User]: ${e.message}`);
			this.server
				.to(
					this.chatGatewayService.getSocketRoomIdentifier(
						info.userID,
	...
	async onSetPassword(
		...
		try {
			...
			this.logger.warn(`[Set Chat Password]: ${e.message}`);
			this.server
				.to(
					this.chatGatewayService.getSocketRoomIdentifier(
						info.userID,
